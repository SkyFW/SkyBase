...
public class TLogPrettyPrinter2  implements TLogPrinter_Interface {
    ...
    public void print(TLogRecord logRecord) {
        ...
        String[] headers = { "log Time", new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").format(logRecord.getTimeStamp())};
        String[][] data = {
                {
                    "Type", logRecord.getType().toString()
                },
                {
                    "Class Name", logRecord.getClassName()
                },
                {
                    "Method Name", logRecord.getMethodName()
                },
                {
                    "file Name", logRecord.getFileName()
                },
                {
                    "exception", new Boolean(logRecord.isException()).toString()
                }
